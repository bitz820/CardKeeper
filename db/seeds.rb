...
description: 'Cash back unlimited', benefits: '5% cash back on travel purchased through Chase, 3% on dining including takeout and drugstores, and 1.5% on all other purchases.', annual_fee: 0, welcome_bonus: '$200 after spend $500 in  the first 3 months, plus 5% cahs back on gas stations', apr: '0%')

CreditCard.create!(img_url: 'https://www.discover.com/content/dam/discover/en_us/credit-cards/card-acquisitions/grey-redesign/global/images/cardart/cardart-cchp-cashbackcard-196-134.png',
    name: 'Discover it', 
    description: 'Unlimited Cash back match', benefits: 'Earn 5% cash back on everyday purchases at different places each quarter, up to the quarterly maximum when you activate.', annual_fee: 0, welcome_bonus: 'Cash back match on the first year, no limit', apr: '0%')
